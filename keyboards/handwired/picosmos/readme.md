...
This is a Cosmo keyboard running on  Rasrberry Pi Pico.

* Keyboard Maintainer: [Gustaw.xyz](https://github.com/massatron)
...
Make example for this keyboard (after setting up your build environment):
    ...
    make handwired/picoCosmo:default

Flashing example for this keyboard:

    make handwired/picoCosmo:default:default:flash
